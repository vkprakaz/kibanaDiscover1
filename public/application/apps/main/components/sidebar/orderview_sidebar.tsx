...
import { OrderviewField } from './orderview_field';
import { OrderviewIndexPattern } from './orderview_index_pattern';
import { OrderviewFieldSearch } from './orderview_field_search';
...
import { OrderviewSidebarResponsiveProps } from './orderview_sidebar_responsive';
...
export interface OrderviewSidebarProps extends OrderviewSidebarResponsiveProps {
  /**
...
export function OrderviewSidebar({
  ...
  if (useFlyout) {
    return (
      <section
        aria-label={i18n.translate('orderview.fieldChooser.filter.indexAndFieldsSectionAriaLabel', {
          defaultMessage: 'Index and fields',
        })}
      >
        <EuiFlexGroup direction="row" gutterSize="s" alignItems="center" responsive={false}>
          <EuiFlexItem grow={true}>
            <OrderviewIndexPattern
  ...
  return (
    <EuiPageSideBar
      ...
      id="orderview-sidebar"
      data-test-subj="orderview-sidebar"
    >
      <EuiFlexGroup
                    ...
                    <EuiAccordion
                      ...
                      buttonContent={
                        <EuiText size="xs" id="selected_fields">
                          <strong>
                            <FormattedMessage
                              id="orderview.fieldChooser.filter.selectedFieldsTitle"
                ...
                <EuiAccordion
                  ...
                  buttonContent={
                    <EuiText size="xs" id="available_fields">
                      <strong>
                        <FormattedMessage
                          id="orderview.fieldChooser.filter.availableFieldsTitle"
                    ...
                    <>
                      <EuiTitle size="xxxs" className="dscFieldListHeader">
                        <h4 id="available_fields_popular">
                          <FormattedMessage
                            id="orderview.fieldChooser.filter.popularTitle"
