...
import { getSchemaDetectors } from './orderview_grid_schema';
import { OrderviewGridFlyout } from './orderview_grid_flyout';
import { OrderviewGridContext } from './orderview_grid_context';
...
import { OrderviewGridDocumentToolbarBtn, getDocId } from './orderview_grid_document_selection';
...
export interface OrderviewGridProps {
  /**
  ...
  const additionalControls = useMemo(
    () =>
      usedSelectedDocs.length ? (
        <OrderviewGridDocumentToolbarBtn
    ...
    return (
      <div className="euiDataGrid__loading">
        <EuiText size="xs" color="subdued">
          <EuiLoadingSpinner />
          <EuiSpacer size="s" />
          <FormattedMessage id="orderview.loadingResults" defaultMessage="Loading results" />
        </EuiText>
      </div>
    );
  }
  ...
  if (!rowCount) {
    return (
      <div className="euiDataGrid__noResults">
        <EuiText size="xs" color="subdued">
          <EuiIcon type="orderviewApp" size="m" color="subdued" />
          <EuiSpacer size="s" />
          <FormattedMessage id="orderview.noResultsFound" defaultMessage="No results found" />
        </EuiText>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        {showDisclaimer && (
          <p className="dscOrderviewGrid__footer">
            <FormattedMessage
              id="orderview.howToSeeOtherMatchingDocumentsDescriptionGrid"
