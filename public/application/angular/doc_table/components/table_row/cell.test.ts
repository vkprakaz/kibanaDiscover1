  ...
  it('renders a cell with filter buttons if it is filterable', () => {
    expect(
      ...
      "<td class=\\"eui-textNoWrap\\" width=\\"1%\\" data-test-subj=\\"docTableField\\">formatted content<span class=\\"kbnDocTableCell__filter\\"><button
              ...
              tooltip=\\"{{ ::'orderview.docTable.tableRow.filterForValueButtonTooltip' | i18n: {defaultMessage: 'Filter for value'} }}\\"
              tooltip-placement=\\"bottom\\"
              aria-label=\\"{{ ::'orderview.docTable.tableRow.filterForValueButtonAriaLabel' | i18n: {defaultMessage: 'Filter for value'} }}\\"
            ><icon type=\\"'plusInCircle'\\" size=\\"'s'\\" color=\\"'primary'\\"></icon></button><button
              ng-click=\\"inlineFilter($event, '-')\\"
              class=\\"kbnDocTableRowFilterButton\\"
              data-column=\\"foo\\"
              data-test-subj=\\"docTableCellFilterNegate\\"
              tooltip=\\"{{ ::'orderview.docTable.tableRow.filterOutValueButtonTooltip' | i18n: {defaultMessage: 'Filter out value'} }}\\"
              aria-label=\\"{{ ::'orderview.docTable.tableRow.filterOutValueButtonAriaLabel' | i18n: {defaultMessage: 'Filter out value'} }}\\"
              tooltip-append-to-body=\\"1\\"
              tooltip-placement=\\"bottom\\"
