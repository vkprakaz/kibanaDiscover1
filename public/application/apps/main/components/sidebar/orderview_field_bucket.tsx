...
import './orderview_field_bucket.scss';
...
export function OrderviewFieldBucket({ field, bucket, onAddFilter }: Props) {
  const emptyTxt = i18n.translate('orderview.fieldChooser.detailViews.emptyStringText', {
    defaultMessage: 'Empty string',
  });
  const addLabel = i18n.translate('orderview.fieldChooser.detailViews.filterValueButtonAriaLabel', {
    defaultMessage: 'Filter for {field}: "{value}"',
    values: { value: bucket.value, field: field.name },
  });
  const removeLabel = i18n.translate(
    'orderview.fieldChooser.detailViews.filterOutValueButtonAriaLabel',
    {
