...
import { OrderviewSidebar } from './orderview_sidebar';
...
export interface OrderviewSidebarResponsiveProps {
  /**
   * Determines whether add/remove buttons are displayed non only when focused
   */
  alwaysShowActionButtons?: boolean;
  /**
   * the selected columns displayed in the doc table in orderview
   */
  columns: string[];
  /**
 ...
 */
export function OrderviewSidebarResponsive(props: OrderviewSidebarResponsiveProps) {
        ...
        <div className="dscSidebar__mobile">
          <section
            aria-label={i18n.translate(
              'orderview.fieldChooser.filter.indexAndFieldsSectionAriaLabel',
              {
          ...
          >
            <FormattedMessage
              id="orderview.fieldChooser.fieldsMobileButtonLabel"
                  ...
                  <h2 id="flyoutTitle">
                    <EuiLink color="text" onClick={() => setIsFlyoutVisible(false)}>
                      <EuiIcon
                        ...
                        aria-label={i18n.translate('orderview.fieldList.flyoutBackIcon', {
                          defaultMessage: 'Back',
                        })}
                        type="arrowLeft"
                      />{' '}
                      <strong>
                        {i18n.translate('orderview.fieldList.flyoutHeading', {
