...
export function TableHeaderColumn({
  ...
  const getSortButtonAriaLabel = () => {
    const sortAscendingMessage = i18n.translate(
      'orderview.docTable.tableHeader.sortByColumnAscendingAriaLabel',
      {
    ...
    const sortDescendingMessage = i18n.translate(
      'orderview.docTable.tableHeader.sortByColumnDescendingAriaLabel',
      {
    ...
    const stopSortingMessage = i18n.translate(
      'orderview.docTable.tableHeader.sortByColumnUnsortedAriaLabel',
      {
  ...
  const buttons = [
    ...
    // Remove Button
    {
      ...
      ariaLabel: i18n.translate('orderview.docTable.tableHeader.removeColumnButtonAriaLabel', {
      ...
      tooltip: i18n.translate('orderview.docTable.tableHeader.removeColumnButtonTooltip', {
    ...
    // Move Left Button
    {
      ...
      ariaLabel: i18n.translate('orderview.docTable.tableHeader.moveColumnLeftButtonAriaLabel', {
      ...
      tooltip: i18n.translate('orderview.docTable.tableHeader.moveColumnLeftButtonTooltip', {
    ...
    // Move Right Button
    {
      ...
      ariaLabel: i18n.translate('orderview.docTable.tableHeader.moveColumnRightButtonAriaLabel', {
      ...
      tooltip: i18n.translate('orderview.docTable.tableHeader.moveColumnRightButtonTooltip', {
