...
import { OrderviewLayoutProps } from '../layout/types';
...
export type OrderviewTopNavProps = Pick<
...
export const OrderviewTopNav = ({
  ...
  return (
    <TopNavMenu
      ...
      showSaveQuery={!!services.capabilities.orderview.saveQuery}
      showSearchBar={true}
