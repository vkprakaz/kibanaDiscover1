...
export interface OrderviewSearchSessionManagerDeps {
  history: History;
 ...
 */
export class OrderviewSearchSessionManager {
  /**
  ...
  constructor(private readonly deps: OrderviewSearchSessionManagerDeps) {}
  ...
  /**
   * Removes Orderviews {@link SEARCH_SESSION_ID_QUERY_PARAM} from the URL
