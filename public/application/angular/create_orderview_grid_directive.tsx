...
import { OrderviewGrid, OrderviewGridProps } from '../components/orderview_grid/orderview_grid';
import { getServices } from '../../kibana_services';
import { ElasticSearchHit } from '../doc_views/doc_views_types';

export const DataGridMemoized = React.memo((props: OrderviewGridProps) => (
  <OrderviewGrid {...props} />
));

export function OrderviewGridEmbeddable(props: OrderviewGridProps) {
...
export function createOrderviewGridDirective(reactDirective: any) {
  return reactDirective(OrderviewGridEmbeddable, [
