...
export declare function createSearchSessionMock(): {
    ...
    session: jest.Mocked<Pick<import("../../../data/public/search").SessionService, "save" | "clear" | "start" | "state$" | "sessionMeta$" | "hasAccess" | "trackSearch" | "destroy" | "getSessionId" | "getSession$" | "isStored" | "isRestore" | "restore" | "continue" | "cancel" | "renameCurrentSession" | "isCurrentSession" | "getSearchOptions" | "enableStorage" | "isSessionStorageReady" | "getSearchSessionIndicatorUiConfig">>;
