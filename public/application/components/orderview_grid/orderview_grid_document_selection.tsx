...
export function OrderviewGridDocumentToolbarBtn({
  isFilterActive,
  rows,
  selectedDocs,
  setIsFilterActive,
  ...
  const getMenuItems = useCallback(() => {
    return [
      isFilterActive ? (
        ...
        >
          <FormattedMessage id="orderview.showAllDocuments" defaultMessage="Show all documents" />
        </EuiContextMenuItem>
      ) : (
        <EuiContextMenuItem
        ...
        >
          <FormattedMessage
            id="orderview.showSelectedDocumentsOnly"
      ...
      >
        {(copy) => (
          <EuiContextMenuItem key="copyJSON" icon="copyClipboard" onClick={copy}>
            <FormattedMessage
              id="orderview.copyToClipboardJSON"
      ...
      >
        <FormattedMessage id="orderview.clearSelection" defaultMessage="Clear selection" />
      </EuiContextMenuItem>,
    ];
  }, [
    isFilterActive,
  ...
  return (
    <EuiPopover
      ...
      button={
        ...
        >
          <FormattedMessage
            id="orderview.selectedDocumentsNumber"
