...
describe('Test orderview initial state sort handling', () => {
...
describe('Test orderview state with legacy migration', () => {
...
describe('createSearchSessionRestorationDataProvider', () => {
  ...
  describe('session name', () => {
    test('No saved search returns default name', async () => {
      expect(await searchSessionInfoProvider.getName()).toBe('Orderview');
    });
