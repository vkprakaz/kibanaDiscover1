...
import { OrderviewGrid, OrderviewGridProps } from './orderview_grid';
import { uiSettingsMock } from '../../../__mocks__/ui_settings';
import { OrderviewServices } from '../../../build_services';
import { ElasticSearchHit } from '../../doc_views/doc_views_types';
import { getDocId } from './orderview_grid_document_selection';

function getProps() {
  const servicesMock = {
    uiSettings: uiSettingsMock,
  } as OrderviewServices;
  return {
    ariaLabelledBy: '',
    columns: [],
...
function getComponent() {
  return mountWithIntl(<OrderviewGrid {...getProps()} />);
}

function getSelectedDocNr(component: ReactWrapper<OrderviewGridProps>) {
...
function getDisplayedDocNr(component: ReactWrapper<OrderviewGridProps>) {
  const gridSelectionBtn = findTestSubject(component, 'orderviewDocTable');
  if (!gridSelectionBtn.length) {
    return 0;
  }
...
async function toggleDocSelection(
  component: ReactWrapper<OrderviewGridProps>,
...
describe('OrderviewGrid', () => {
  describe('Document selection', () => {
    let component: ReactWrapper<OrderviewGridProps>;
    beforeEach(() => {
