...
import { OrderviewSidebarProps } from './orderview_sidebar';
...
import { orderviewServiceMock as mockOrderviewServices } from '../../../../../__mocks__/services';

jest.mock('../../../../../kibana_services', () => ({
  getServices: () => mockOrderviewServices,
}));
...
function getCompProps(): OrderviewSidebarProps {
  ...
  return {
    ...
    services: mockOrderviewServices,
    state: {},
...
describe('orderview sidebar', function () {
  let props: OrderviewSidebarProps;
  let comp: ReactWrapper<OrderviewSidebarProps>;

  beforeAll(() => {
    props = getCompProps();
    comp = mountWithIntl(<OrderviewSidebar {...props} />);
  });
