...
export interface OrderviewIndexPatternTitleProps {
  /**
 ...
 */
export function OrderviewIndexPatternTitle({
  isChangeable,
  onChange,
  title,
}: OrderviewIndexPatternTitleProps) {
  return (
      ...
      {isChangeable && (
        <EuiFlexItem grow={false}>
          <EuiToolTip
            content={
              <FormattedMessage
                id="orderview.fieldChooser.indexPattern.changeLinkTooltip"
                defaultMessage="Change current index pattern"
              />
            }
          >
            <EuiButtonEmpty
              aria-label={i18n.translate('orderview.fieldChooser.indexPattern.changeLinkAriaLabel', {
                defaultMessage: 'Change current index pattern',
              })}
