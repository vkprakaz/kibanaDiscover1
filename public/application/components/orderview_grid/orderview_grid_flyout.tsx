 ...
 */
export function OrderviewGridFlyout({
  hit,
  hits,
  indexPattern,
  columns,
    ...
    <EuiPortal>
      ...
      >
        <EuiFlyoutHeader hasBorder>
          ...
          >
            <h2>
              {i18n.translate('orderview.grid.tableRow.detailHeading', {
          ...
          <EuiFlexGroup responsive={false} gutterSize="s" alignItems="center">
            <EuiHideFor sizes={['xs', 's', 'm']}>
              <EuiFlexItem grow={false}>
                <EuiText size="s">
                  <strong>
                    {i18n.translate('orderview.grid.tableRow.viewText', {
                      defaultMessage: 'View:',
                    })}
                  </strong>
                </EuiText>
            ...
            <EuiFlexItem grow={false}>
              <EuiButtonEmpty
                ...
                href={services.addBasePath(
                  `/app/orderview#/doc/${indexPattern.id}/${hit._index}?id=${encodeURIComponent(
                    hit._id as string
                  )}`
                )}
                data-test-subj="docTableRowAction"
              >
                {i18n.translate('orderview.grid.tableRow.viewSingleDocumentLinkTextSimple', {
            ...
            {indexPattern.isTimeBased() && indexPattern.id && (
              <EuiFlexItem grow={false}>
                <EuiButtonEmpty
                  ...
                  data-test-subj="docTableRowAction"
                >
                  {i18n.translate('orderview.grid.tableRow.viewSurroundingDocumentsLinkTextSimple', {
            ...
            {activePage !== -1 && (
              <EuiFlexItem>
                <EuiPagination
                  aria-label={i18n.translate('orderview.grid.flyout.documentNavigation', {
          ...
          <DocViewer
            ...
            filter={(mapping, value, mode) => {
              ...
              services.toastNotifications.addSuccess(
                i18n.translate('orderview.grid.flyout.toastFilterAdded', {
            ...
            onRemoveColumn={(columnName: string) => {
              ...
              services.toastNotifications.addSuccess(
                i18n.translate('orderview.grid.flyout.toastColumnRemoved', {
            ...
            onAddColumn={(columnName: string) => {
              ...
              services.toastNotifications.addSuccess(
                i18n.translate('orderview.grid.flyout.toastColumnAdded', {
