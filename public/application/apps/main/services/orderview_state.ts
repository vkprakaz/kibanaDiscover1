...
import { ORDERVEW_APP_URL_GENERATOR, OrderviewUrlGeneratorState } from '../../../../url_generator';
...
export interface GetStateReturn {
  ...
  /**
   * Function starting state sync when Orderview main is loaded
   */
  initializeAndSync: (
  ...
  return {
    getName: async () => {
      ...
      return (
        ...
        i18n.translate('orderview.orderviewDefaultSearchSessionName', {
    ...
    getUrlGeneratorData: async () => {
      return {
        urlGeneratorId: ORDERVEW_APP_URL_GENERATOR,
