...
import {
  ...
  getDocId,
  SelectButton,
} from './orderview_grid_document_selection';
...
describe('document selection', () => {
  ...
  describe('SelectButton', () => {
    test('is not checked', () => {
      ...
      const component = mountWithIntl(
        <OrderviewGridContext.Provider value={contextMock}>
          <SelectButton
            rowIndex={0}
  ...
  describe('OrderviewGridDocumentToolbarBtn', () => {
    test('it renders a button clickable button', () => {
      ...
      const component = mountWithIntl(<OrderviewGridDocumentToolbarBtn {...props} />);
